...
class CreateLectureClassDebate extends \LaravelSupports\Libraries\Supports\Databases\Migrations\CreateMigration
{
    protected string $table = 'lecture_class_debate';
...
//        $table->index(['member_lecture_program_idx', 'lecture_class_idx'], 'lecture_class_debate_member_IX');
    }
