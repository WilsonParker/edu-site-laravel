...
class CreateLectureClassMemo extends \LaravelSupports\Libraries\Supports\Databases\Migrations\CreateMigration
{
    protected string $table = 'lecture_class_memo';
...
//        $table->index(['member_lecture_program_idx', 'lecture_class_idx'], 'lecture_class_memo_member_IX');
    }
