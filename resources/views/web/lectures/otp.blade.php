@extends('web.layouts.minimum')

<!--
    한국산업인력공단에서 제공하는 OTP 인증시스템 연동 데모 페이지입니다.
    작성일 : 2019.12.04
-->
        ...
        */
        ...
        function validateOtp() {
            ...
            try {
                ...
                var COURSE_AGENT_PK = "course_001";
                var CLASS_AGENT_PK = "class_001";
                var EVAL_CD = "01";
                var EVAL_TYPE = "진도";
                var CLASS_TME = "01";
                ...
                $.ajax({
                    ...
                    success : function(xml) {
                        if($(xml).find("RetVal").text() == "101") {
                            ...
                            location.href = "{!! route('lectures.otp.complete', $data) !!}";
                        } else {
                            /* 키패드를 화면에서 제거함. */
                            hideKeypad();
    ...
    <Table width="100%">
        <Tr height="50px">
            <Td width="100%" align="CENTER">
                <P><font size="5"><b>한국산업인력공단 OTP 연계 데모화면입니다.</b></font></P>
                <P>아래 [OTP 호출] 버튼을 클릭하시면 OTP 등록절차 및 OTP 비밀번호가 화면에 표출됩니다.</P>
            </Td>
        </Tr>
        <Tr height="350px">
            <Td width="100%" valign="TOP">
                <input type="button" value="OTP 호출 " onclick="checkifOtpStatus();">
                <BR/>
                <!-- **************************************************************************************
                    ** OTP 프레임 영역 세팅
                ...
                ************************************************************************************** -->
                <Div id="hrdOtpFrame" style="width:700px;height:350px"></Div>
            </Td>
        </Tr>
        <Tr height="350px">
            <Td width="100%">
                <HR/>
                -->> OTP 비밀번호 검증 <BR>
                <input type="password" id="otpVal" onclick="showKeypad(this);"/>
                <input type="button" value="입력확인" onclick="validateOtp('aa');" style="margin-left:10px"/>
                <HR/>
            </Td>
        </Tr>
    </Table>

    {{--<a class="btn btn-primary" href="{{ route('lectures.otp.complete', $data) }}">Complete</a>--}}
@endsection
